    ...
    function homeCtrl() {
        ...
        vm.data = {
            trips: [{
                ...
                items: ['Diario', 'Vagas: 3', 'Homen', 'Honda Civic', 'Preto', 'HAO-1462'],
                ...
                items: ['Diario', 'Vagas: 1', 'Mulher', 'Fiat Punto', 'Branco', 'HKJ-5407'],
                ...
                items: ['Puntual', 'Vagas: 3', 'Homen', 'Nissan Livina', 'Vermelho', 'HEX-0049'],
                ...
                items: ['Puntual', 'Vagas: 1', 'Homen', 'Fiat Siena', 'Preto', 'AAA-4444'],
                ...
                items: ['Diario', 'Vagas: 2', 'Mulher', 'Audi A3', 'Cinza', 'HNP-3131'],
